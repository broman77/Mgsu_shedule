...
data class SuggestionCatalog(
    ...
    val teacherSources: Map<String, List<String>> = emptyMap(),
    /** Canonical group -> official PDF URLs containing that group. */
    val groupSources: Map<String, List<String>> = emptyMap(),
    /** URL -> human-readable source label from the official MGSU page. */
